...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="<?php echo base_url() ?>assets/2/plugins/iCheck/square/blue.css">
...
<div class="login-box">
  ...
  <img src="<?php echo base_url() ?>assets/2/dist/img/amni1.png" width="20%">
    <a href="../../index2.html"><b>Admin</b> SKI</a>
  </div>
  <!-- /.login-logo -->
...
<!-- iCheck -->
<script src="<?php echo base_url() ?>assets/2/plugins/iCheck/icheck.min.js"></script>
<script>
  $(function () {
    $('input').iCheck({
